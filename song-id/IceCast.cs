...
namespace song_id
{
    internal class IceCast
    {
        ...
        private static string urlStem = "/admin/metadata?mount=/{0}&mode=updinfo&song={1}";
        ...
        internal async void UpdateIceCastMetadata(ShazamResult shazamResult)
        {
            ...
            httpRequest.RequestUri = new Uri(string.Format(urlStem, _mount, songString), UriKind.Relative);
